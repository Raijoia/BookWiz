USE DB_BOOKWIZ;
SELECT * FROM TB_USER;
INSERT INTO TB_USER (USU_NOME, USU_SENHA, USU_IDADE, USU_SEXO, USU_EMAIL, USU_PREF, TP_ID) 
	values ('Bruno Trova', '123456', 18, 'Masculino', 'brunotrova@gmail.com', 1, 1);
drop table TB_LIVRO;
...
CREATE TABLE TB_ESCOLHER (
	PREF_ID INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
    USU_ID INT NOT NULL,
    GEN_ID INT NOT NULL,
    FOREIGN KEY (USU_ID) REFERENCES TB_USER(USU_ID),
...
ALTER TABLE TB_USER ADD AVA_ID INT;
